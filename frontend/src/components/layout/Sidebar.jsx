...
const userNavItems = [
  ...
  { label: 'Hiệu quả (KPI)', path: '/user/performance', icon: <PerformanceIcon /> },
];
...
const hrNavItems = [
  ...
  { label: 'Duyệt Đề xuất',     path: '/hr/promotions', icon: <DocumentIcon /> },
];
...
const managerNavItems = [
  ...
  { label: 'Đánh giá nhân viên', path: '/manager/evaluation',        icon: <PerformanceIcon /> },
  { label: 'Quản lý Đề xuất',    path: '/manager/promotions',        icon: <DocumentIcon /> },
];
...
const Sidebar = () => {
  ...
  else if (user?.role === 'manager') navItems = managerNavItems;
