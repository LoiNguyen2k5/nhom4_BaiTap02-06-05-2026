...
const TaxConfig = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage({ type: 'success', text: 'Cập nhật cấu hình Thuế/Bảo hiểm thành công!' });
    } catch (error) {
  ...
  return (
    <div className="space-y-5 max-w-3xl">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mt-0.5">Dành cho Kế toán quản lý các thông số dùng cho tính lương và khấu trừ thuế</p>
      </div>
